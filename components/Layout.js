            ...
            <header>
                <nav className='flex h-12 items-center px-4 justify-between shadow-md'>
                    ...
                    <div>
                        ...
                        {status==='loading'? ('Loading'):session?.user? (<Menu as="div" className="relative inline block">
                           ...
                           <Menu.Items className='absolute right-0 w-56 origin-top-right bg-white shadow-lg'>
                            ...
                            <Menu.Item as="div">    <DropdownLink className="dropdown-link" href="/order-history">Order History</DropdownLink></Menu.Item> 
                             <Menu.Item as="div">   <a className="dropdown-link" href="#" onClick={logoutClickHandler}>Logout</a></Menu.Item>
                           </Menu.Items>
                        </Menu>):(<Link href="/login"><a className='p-2'> Login</a></Link>)}
                    </div>
                </nav></header>
