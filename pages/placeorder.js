...
if(!paymentMethod){
    ...
    return (<Layout title='Place Order'>
        ...
        {cartItems.length ===0?(<div>Cart is empty.<Link href='/'>Go shopping</Link></div>):(<div className='grid md:grid-cols-4 md:gap-5'>
            <div className='overflow-x-auto md:col-span-3'>
              ...
              <tbody>{cartItems.map((item)=>(<tr key={item._id} className='border-b'>
                <td>
