...
router.push('/payment');     
    ...
    return (
        ...
        <Layout title="Shipping Address">
           ...
           <div className='mb-4'><label htmlFor='fullName'>Full Name</label>
           ...
           <div className='mb-4'><label htmlFor='address'>Address</label>
           <input className='w-full' id='address' autoFocus {...register('address',{required:'Please enter address', minLength:{value:3, message: 'Address is more than 2 chars'}})}/>
           {errors.address &&(<div className='text-red-500'>{errors.address.message}</div>)}
           </div>
           <div className='mb-4'><label htmlFor='city'>City</label>
           ...
           <div className='mb-4'><label htmlFor='postalCode'>Postal Code</label>
           ...
           <div className='mb-4'><label htmlFor='country'>Country</label>
